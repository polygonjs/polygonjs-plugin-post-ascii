...
// import {AsciiPostNode} from '..
import { AsciiPostNode } from "../PolyConfig";
// rop
...
export class PolySceneWithNodeMap_scene_01 extends PolyScene {
  ...
  override node(path: "/cameras/cameraPostProcess1"): CameraPostProcessSopNode;
  override node(path: "/cameras/cameraPostProcess1/OUT"): NullPostNode;
  override node(path: "/cameras/cameraPostProcess1/ascii1"): AsciiPostNode;
  override node(path: "/cameras/cameraPostProcess1/ascii2"): AsciiPostNode;
  override node(path: "/cameras/cameraRenderer1"): CameraRendererSopNode;
  override node(
    path: "/cameras/cameraRenderer1/WebGLRenderer1"
...
export interface PolySceneProps_scene_01 {
  ...
  "cameras-cameraPostProcess1--group"?: ParamValueSerializedTypeMap["string"];
  ...
  "cameras-cameraPostProcess1-ascii1--characters"?: ParamValueSerializedTypeMap["string"];
  "cameras-cameraPostProcess1-ascii1--fontSize"?: ParamValueSerializedTypeMap["integer"];
  "cameras-cameraPostProcess1-ascii1--cellSize"?: ParamValueSerializedTypeMap["integer"];
  "cameras-cameraPostProcess1-ascii1--color"?: ParamValueSerializedTypeMap["color"];
  "cameras-cameraPostProcess1-ascii1--color-colorr"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-ascii1--color-colorg"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-ascii1--color-colorb"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-ascii1--colorr"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-ascii1--colorg"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-ascii1--colorb"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-ascii2--characters"?: ParamValueSerializedTypeMap["string"];
  "cameras-cameraPostProcess1-ascii2--fontSize"?: ParamValueSerializedTypeMap["integer"];
  "cameras-cameraPostProcess1-ascii2--cellSize"?: ParamValueSerializedTypeMap["integer"];
  "cameras-cameraPostProcess1-ascii2--color"?: ParamValueSerializedTypeMap["color"];
  "cameras-cameraPostProcess1-ascii2--color-colorr"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-ascii2--color-colorg"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-ascii2--color-colorb"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-ascii2--colorr"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-ascii2--colorg"?: ParamValueSerializedTypeMap["float"];
  "cameras-cameraPostProcess1-ascii2--colorb"?: ParamValueSerializedTypeMap["float"];
